...
void ShowMainMenu(void)
{
    std::cout << " Главное меню:" << std::endl
        << " 1 - Ввести данные" << std::endl
        << " 2 - Вывести данные" << std::endl
        << " 3 - Очистить все данные" << std::endl
        << " 4 - Отфильтровать сотрудников" << std::endl
        // << " 5 - Удалить сотрудника" << std::endl
        << " 0 - Завершить работу программы" << std::endl
        << std::endl;
}
...
void ShowInputMenu(void)
{
    std::cout << " 1 - Ввести с консоли" << std::endl
        << " 2 - Ввести с файла" << std::endl
        << " 0 - Выйти в главное меню" << std::endl
        << std::endl;
}

void ShowOutputMenu(void)
{
    std::cout << " 1 - Вывести в консоль" << std::endl
        << " 2 - Вывести в файл" << std::endl
        << " 0 - Выйти в главное меню" << std::endl
        << std::endl;
}
...
{
    std::cout << " 1 - Отфильтровать по стажу" << std::endl
        << " 2 - Отфильтровать по зарплате" << std::endl
        << " 3 - Отфильтровать по должности" << std::endl
        << " 0 - Выйти в главное меню" << std::endl
        << std::endl;
}
